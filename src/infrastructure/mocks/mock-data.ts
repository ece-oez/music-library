...
export const mockAlbums: Album[] = [
  {
    ...
    mediaLinks: [{ id: 'link-dark-side', url: 'https://www.youtube.com/watch?v=HrxX9TBj2zY', label: 'Play album on YouTube' }],
    rating: 5,
    isFavorite: true,
  ...
  },
  {
    ...
    mediaLinks: [{ id: 'link-kind-blue', url: 'https://www.youtube.com/watch?v=kgRcCyey1qE', label: 'Play album on YouTube' }],
    rating: 5,
    isFavorite: false,
  ...
  },
  {
    ...
    mediaLinks: [{ id: 'link-hounds', url: 'https://www.youtube.com/watch?v=wp43OdtAAkM', label: 'Play album on YouTube' }],
    rating: 4,
    isFavorite: true,
  ...
  },
  {
    ...
    mediaLinks: [{ id: 'link-blue-train', url: 'https://www.youtube.com/watch?v=HT_Zs5FKDZE', label: 'Play album on YouTube' }],
    rating: 4,
    isFavorite: false,
